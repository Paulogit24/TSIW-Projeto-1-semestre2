     ...
     const users = [
      {
        ...
        password: "admin1",
        exp: 0,
        banner: "/accelair app/img/adminbanner1.jpg",
        userimage: "/accelair app/img/usericon/adminicon.png",
        aboutuser: "Sou uma pessoa organizada, focada em resultados e movida por desafios. Tenho facilidade em me adaptar a diferentes contextos e gosto de colaborar com equipes diversas. Acredito na importância do aprendizado contínuo e procuro aplicar esse princípio tanto na minha vida profissional quanto pessoal. Para mim, comprometimento e responsabilidade são fundamentais em qualquer projeto.",
        admin: 1,
        funds: 7000,
      },
      {
        ...
        password: "user1",
        exp: 0,
        banner: "/accelair app/img/userbanner1.png",
        userimage: "/accelair app/img/usericon/usericon1.png",
        aboutuser: "Sou uma pessoa curiosa por natureza, apaixonada por aprender e entender como as coisas funcionam. Gosto de me envolver em projetos que desafiem minha criatividade e exigem dedicação. Valorizo conexões verdadeiras, o trabalho em equipe e acredito que cada experiência, boa ou ruim, traz uma lição importante. Estou em constante evolução, buscando sempre ser uma versão melhor de mim mesmo a cada dia.",
        admin: 0,
        funds: 5000,
      },
      {
        ...
        password: "user2",
        exp: 3000,
        banner: "/accelair app/img/userbanner2.jpg",
        userimage: "/accelair app/img/usericon/usericon2.png",
        aboutuser: "Vejo o mundo com olhos curiosos e coração aberto. Gosto de observar detalhes, ouvir histórias e transformar experiências em aprendizados. Escrevo, crio, me reinvento. Sou alguém que sente muito, sonha alto e acredita que cada passo tem um propósito. Não busco perfeição, mas verdade, conexão e crescimento. No fundo, estou sempre em busca de mim mesma.",
        admin: 0,
        funds: 9000,
      },
